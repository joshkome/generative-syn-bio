...
Scaffolding pipeline that connects [Cello](https://github.com/CIDAR-LAB/Cello-v2) circuit design outputs to the [Evo 2](https://github.com/ArcInstitute/evo2) DNA language model for context-aware part sequence generation.
